...
from model.VSLBase import build_optimizer_and_scheduler, VSLBase #----------------------------------------------------------------MODIFICATO
    ...
    if configs.mode.lower() == "train":
        ...
        for epoch in range(configs.epochs):
            ...
            for data in tqdm(
                ...
                # compute logits
                start_logits, end_logits = model( #----------------------------------------------------------------MODIFICATO
                ...
                total_loss = loc_loss #----------------------------------------------------------------MODIFICATO
